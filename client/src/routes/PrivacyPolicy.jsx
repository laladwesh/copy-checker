          ...
          <div className="max-w-4xl mx-auto px-6 py-12 lg:px-16 lg:py-20">
            ...
            <div className="space-y-16">
              ...
              <section id="data-collection" className="scroll-mt-32">
                <h2 className="font-serif text-3xl text-slate-900 mb-6">2. Data Collection Framework</h2>
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="border border-slate-200 p-8 hover:border-black transition-colors duration-300">
                    <DocumentTextIcon className="h-8 w-8 text-slate-900 mb-4" />
                    <h3 className="font-bold text-lg mb-3">Personal Identifiers</h3>
                  ...
                  <div className="border border-slate-200 p-8 hover:border-black transition-colors duration-300">
                    <DocumentTextIcon className="h-8 w-8 text-slate-900 mb-4" />
                    <h3 className="font-bold text-lg mb-3">Academic Records</h3>
                    <ul className="space-y-2 text-slate-600 text-sm leading-relaxed">
              ...
              <section id="usage-protocol" className="scroll-mt-32">
                <h2 className="font-serif text-3xl text-slate-900 mb-6">3. Usage Protocol</h2>
                ...
                <div className="pl-6 border-l-2 border-slate-900 space-y-4">
                  <div>
                    <strong className="block text-slate-900 font-medium">Evaluation Mechanics</strong>
                    <span className="text-slate-600">To enable examiners to digitally review, annotate, and grade student submissions.</span>
                  </div>
                  <div>
                    <strong className="block text-slate-900 font-medium">Audit Trails</strong>
                    <span className="text-slate-600">To maintain an immutable record of grade changes and system access for accountability.</span>
                  </div>
                  <div>
                    <strong className="block text-slate-900 font-medium">Institutional Compliance</strong>
                    <span className="text-slate-600">To generate necessary reports required by the university examination cell.</span>
                  </div>
                </div>
              </section>
              ...
              <section id="storage-&-security" className="scroll-mt-32">
                <h2 className="font-serif text-3xl text-slate-900 mb-6">4. Storage & Security Infrastructure</h2>
                <div className="bg-slate-900 text-white p-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-slate-800 pt-6">
                    <div>
                      <h4 className="font-bold text-sm uppercase tracking-wide text-slate-500 mb-2">Document Storage</h4>
                      <p className="text-sm">Secure Google Drive API containers with restricted service account access.</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-sm uppercase tracking-wide text-slate-500 mb-2">Database</h4>
                      <p className="text-sm">MongoDB Enterprise with Role-Based Access Control (RBAC) enforcement.</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="user-rights" className="scroll-mt-32">
                <h2 className="font-serif text-3xl text-slate-900 mb-6">5. User Rights</h2>
                <div className="space-y-6">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {['Right to Access', 'Right to Rectification', 'Right to Erasure', 'Right to Export'].map((right) => (
                      <li key={right} className="flex items-center gap-3 p-4 bg-slate-50 border border-slate-100">
              ...
              {/* Section 6 */}
              <section id="legal-contact" className="scroll-mt-32 border-t border-slate-200 pt-16">
                <h2 className="font-serif text-3xl text-slate-900 mb-8">6. Contact Administration</h2>
                ...
                <div className="flex flex-col md:flex-row gap-12">
                  <div className="flex-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-slate-600">Prasad Institute of Medical Sciences</p>
                      <a href="mailto:info@prasad.edu.in" className="text-slate-900 border-b border-black hover:bg-black hover:text-white transition-colors">info@prasad.edu.in</a>
                    </div>
                  </div>

                  <div className="flex-1 bg-slate-50 p-6 border border-slate-200">
                    <h4 className="font-bold text-sm mb-2">Mailing Address</h4>
