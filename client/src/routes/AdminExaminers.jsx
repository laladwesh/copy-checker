      ...
      <div className="max-w-full mx-auto mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Monitor evaluation progress and examiner workloads.</p>
          </div>
          <button 
            onClick={() => navigate(-1)} 
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          {/* Toolbar */}
          <div className="p-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between gap-4 bg-white">
            <h2 className="text-lg font-semibold text-gray-800 self-center">Detailed List</h2>
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-shadow"
              />
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Examiner</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Workload</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-1/3">Progress</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {isLoading ? (
                  <tr>
                    <td colSpan="5" className="px-6 py-10 text-center text-gray-500">Loading data...</td>
                  </tr>
                  ...
                  filteredExaminerStats.map((examiner) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-10 w-10">
                              <div className="h-10 w-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-700 font-bold text-sm border border-indigo-100">
                        ...
                        {/* Workload Column */}
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900 font-medium">{examiner.totalCopiesAssigned} <span className="text-gray-400 font-normal">Assigned</span></div>
                          <div className="text-xs text-gray-500">{examiner.totalCopiesEvaluated} Evaluated</div>
                        </td>
...
function StatCard({ title, value, icon: Icon, isProgress, progress }) {
  return (
    <div className="bg-white overflow-hidden rounded-xl border border-gray-200 shadow-sm p-5 flex flex-col justify-between h-full">
